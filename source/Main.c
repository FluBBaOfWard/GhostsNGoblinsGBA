...
//---------------------------------------------------------------------------------
	...
	showSplash(getSplashScreen(GNGID));
...
//---------------------------------------------------------------------------------
	...
	REG_BG1CNT = TEXTBG_SIZE_256x256 | BG_MAP_BASE(1) | BG_TILE_BASE(2) | BG_PRIORITY(2);
	REG_BG2CNT = TEXTBG_SIZE_256x256 | BG_MAP_BASE(3) | BG_TILE_BASE(2) | BG_PRIORITY(1);
